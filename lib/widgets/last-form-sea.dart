...
class LastFormSea extends StatefulWidget {
  // final PageController c;
  // LastForm(this.c);

  @override
  _LastFormSeaState createState() => _LastFormSeaState();
}

class _LastFormSeaState extends State<LastFormSea> {
                  ...
                  if (Registration.isLoginGuest == true) {
                    ...
                    if (_fbKey.currentState.saveAndValidate()) {
                      ...
                      allOrders
                        ...
                        seaType: allOrders.theSeaData.seaType,
                        yearOfMan: allOrders.theSeaData.yearOfManu,
                        limitOfResp: allOrders.theSeaData.limitOfResp,
